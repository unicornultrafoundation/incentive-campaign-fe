export const stakePublicV2Abi = [
  {
    type: 'constructor',
    stateMutability: 'nonpayable',
    inputs: [
      { type: 'address', name: '_pUSDT', internalType: 'address' },
      { type: 'address', name: '_incentivePoolV1', internalType: 'address' },
    ],
  },
  ...
  },
  {
    ...
    outputs: [
      ...
      { type: 'uint256', name: 'debt', internalType: 'uint256' },
    ],
    name: 'getUserInfo',
